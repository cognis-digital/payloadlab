#!/usr/bin/env sh
# Universal installer for payloadlab. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/payloadlab.git"
echo "Installing payloadlab ..."
